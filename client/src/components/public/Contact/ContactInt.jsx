    ...
    <div className=''>
      <div className="cadre">
        <div className="formulaire">
          ...
          <form action="">
            <div className="mb-3">
              <input type="email" required className="form-control"  placeholder="Votre email" />
            </div>
            <div className="mb-3">
        ...
        <div className="image flexColCenter">
              ...
              <div className="info flexColStart">
                <span><span className="icon "><FaLocationDot/></span> <span className='secondaryText'>+261 34 00 000 00</span></span>
                <span><span className="icon "><SiGmail/></span > <span className='secondaryText'>Rue de commerce, Antananarivo Madagascar</span></span>
                <span><span className="icon "><IoCall /></span> <span className='secondaryText'>primexlogistics@yahoo.fr</span> </span>
              </div>
        </div>
