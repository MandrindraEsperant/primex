...
const TransportMaritime = () => {
    ...
    const handleSelect = (person) => {
        if (selectedPerson && selectedPerson.idTransMaritime === person.idTransMaritime) {
              ...
              <div className="container">
                  <div className="tableContainer">
                      <div className="actionsContainer">
                          <div className="searchContainer">
                              ...
                              <AjoutTransM open={open} handleClose={handleClose}/>
                  ...
                  <div className="detailContainer">
                      <div className="detailHeader">
                          {selectedPerson && <img src='' alt={selectedPerson.nomBateau} className="detailImage" />}
                          <h3>Détails : {selectedPerson ? selectedPerson.numHBL : ''}</h3>
                      </div>
                      <p><strong>N° HBL :</strong> {selectedPerson ? selectedPerson.numHBL : ''}</p>
                      <p><strong>N° Bateau :</strong> {selectedPerson ? selectedPerson.numBateau : ''}</p>
                      <p><strong>Nom Bateau :</strong> {selectedPerson ? selectedPerson.nomBateau : ''}</p>
