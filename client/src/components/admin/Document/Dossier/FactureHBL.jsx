...
const FactureHBL = () => {
  ...
  const handleHawbTracking = async (num) => {
    ...
    try {
      ...
      generateMawb(idMBL.data.idMBL);
      console.log(idMBL.data.idMBL);
  ...
  const handlePrint = () => {
    ...
    const options = {
      margin: 1,
      filename: "Facture HBL" + hawbData.numHBL,
      ...
      <div className="">
        <div className="relative inline-block w-80 m-2">
          <select
            ...
            onChange={(e) => {
              setIdHBL(e.target.value);
              handleHawbTracking(e.target.value);
            }}
          ...
          >
            ...
            {hbl.map((v) => (
              <option key={v.idHBL} value={v.numHBL}>
                {v.numHBL}
              </option>
            ))}
          </select>
                ...
                {mawbData && (
                  <>
                    <h2 className="text-2xl font-bold mb-4 text-center text-blue-600">
                      Suivi de colis HBL N°:{hawbData.numHBL}
                    </h2>
                    <div className=" ">
                      <div className=" flex justify-between">
                        <div className=" ">
                          ...
                          <p>
                            ...
                            {mawbData.TransMaritime.armateur}
                          </p>
                          <p>
                            <strong>Numero IMO :</strong>
                            {mawbData.TransMaritime.numIMO}
                          </p>
                        </div>
                        <div className=" ">
                          <p>
                            <strong> Date de chargement:</strong>
                            {mawbData.TransMaritime.dateChargement}
                          </p>
                          <p>
                            <strong> Pays de chargement:</strong>
                            {mawbData.TransMaritime.paysChargement}
                          </p>
                          <p>
                            <strong> Ville de chargement:</strong>
                            {mawbData.TransMaritime.villeChargement}
                          </p>
                          <p>
