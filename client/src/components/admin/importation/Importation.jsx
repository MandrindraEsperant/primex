...
const Importation = () => {
  ...
  const supprimer = (id) => {
    axios.delete('http://localhost:3001/importation/'+id)
        .then(res =>  {
         console.log(res);
         allImportation();
        })
    ...
    <div className={`client-container ${theme}`}>
      ...
      <div className="container">
                ...
                >
                  ...
                  <td>
                    <span className="actionIcons">
                      ...
                      <MdDelete className="deleteIcon" onClick={()=>supprimer(item.idImportation)} />
        ...
        <div className="detailContainer">
          ...
          <p>
            <strong>Nom :</strong> {selectedPerson ? selectedPerson.nom : ""}
          </p>
          <p>
            <strong>Adresse :</strong>{" "}
            {selectedPerson ? selectedPerson.adresse : ""}
          </p>
          <p>
            <strong>Contact :</strong>{" "}
            {selectedPerson ? selectedPerson.contact : ""}
          </p>
          <p>
            <strong>Email :</strong>{" "}
